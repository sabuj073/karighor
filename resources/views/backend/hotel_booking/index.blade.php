...
@section('title', 'All Hotel Booking Info')
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="text-center">Active Hotel Booking </h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody class="table text-center">
                                            ...
                                            @foreach ($activeRequirement as $index => $requirement)
                                                {{-- @php
                                                    $ticket_info_json = json_decode($requirement->booking_info);
                                                    $count_name = 0;
                                                    $count_photo = 0;
                                                ...
                                                @endphp --}}
                                                    <tr>
                                                        ...
                                                        <td><img width="80px" src="{{ $requirement->photo }}"
                                                                alt="">
                                                        </td>
                                                        ...
                                                        <td class="td_btn">
                                                            <a href="{{ route('backend.hotelBooking.edit', $requirement->id) }}"
                                                                class="btn btn-sm btn-info">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            <a href="{{ route('backend.hotelBooking.status', $requirement->id) }}"
                                                            ...
                                                            <a href="{{ route('backend.hotelBooking.trash', $requirement->id) }}"
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="text-center">Draft Hotel Booking</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                    ...
                    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="text-center">Trashed Hotel Booking</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                            ...
                                            @foreach ($trashedRequirement as $index => $requirement)
                                                ...
                                                @endphp --}}
                                                    ...
                                                    <td class="td_btn d-flex text-center">
                                                        <a href="{{ route('backend.hotelBooking.reStore', $requirement->id) }}"
                                                            class="btn btn-success mr-2">
                                                            <i class="fa-solid fa-box mr-1"></i>
                                                        </a>
                                                        <form
                                                            action="{{ route('backend.hotelBooking.delete', $requirement->id) }}"
