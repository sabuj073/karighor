                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header">
                                <h1 class="text-center">Create Product Info</h1>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                ...
                                {{-- <div class="row mt-3">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" name="sku" id="" class="form-control"
                                            placeholder="Enter Code" value="{{ old('sku') }}">
                                    </div>
                                </div> --}}
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class=" form-group col-lg-6">
                                        ...
                                        <input type="number" name="order_number" class=" form-control" placeholder="Enter Order Number" value="{{ old('order_number') }}">
                                ...
                                <div class="row mt-3">
                                    <div class=" form-group">
                                        ...
                                        <textarea name="feature" id="" class=" form-control" rows="3" placeholder="Enter Short Description"></textarea>
                                    </div>
