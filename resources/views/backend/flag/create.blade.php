...
@section('title', 'Create Air Ticket')
@section('content')
            ...
            <div class="flex">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create Air Ticket</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section>
        <div class="container-fluid">
            <form action="{{ route('backend.flag.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header">
                                <h1 class="text-center">Create Air Ticket</h1>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row mt-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="short_description" id="editor2" class="form-control"></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-header">
                                <h1 class="text-center">Meta Info</h1>
                            </div>
                            <div class="card-body">
