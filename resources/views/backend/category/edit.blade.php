...
@section('content')
    ...
    <section>
        <div class="container">
            <form action="{{ route('backend.category.update',$category) }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <img src="{{ $category->logo }}" class="mt-3" width="80" alt="">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <img src="{{ $category->banner }}" class="mt-3" width="80" alt="">
                                    <img id="baner_img" class="mt-3" src="#" alt="Preview"
                                            style="display: none; max-width: 80px; max-height: 80px;">
                                </div>
                                <div class="form-group mt-3">
                                    <label>Order Level:</label>
                                    <input type="text" class="form-control" name="order_level" id="" value="{{ $category->order_level }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ $category->m_photo }}" class="mt-3" width="80" alt="">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <textarea name="m_description" id="" class="form-control" rows="3">
                                      {{ $category->m_description }}
                                    </textarea>
                                </div>
                            </div>
                        </div>
