                            ...
                            <form action="{{ route('backend.services.update', $services->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class=" form-group col-lg-4">
                                        <label>Change Background(89x58):</label>
                                        <input type="file" name="b_photo" class=" form-control" id="photoInput"
                                            value="{{ old('b_photo') }}">
                                        <img src="{{ $services->b_photo }}" width="80px" class="mt-2" alt="">
                                ...
                                <div class="row">
                                    <div class="mt-3 form-group">
                                        <label>Title</label>
                                        <input type="text" class="form-control" value="{{ $services->title_head }}"
                                            name="title_head" id="">
                                    </div>
                                    <div class="mt-3 form-group">
                                        <label>Description:</label>
                                        <textarea name="description_head" id="editor" class="form-control " rows="7" placeholder="Enter Description">{!! $services->description_head !!}</textarea>
                                    </div>
                                </div>
