            ...
            <div class="flex">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Dream With Us</li>
                    </ol>
                </nav>
                <h1 class="m-0">Dream With Us</h1>
            </div>
        </div>
    </div>
    <section>
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <h1 class="text-center">Dream With Us</h1>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('backend.dreamWithUs.store') }}" method="POST"
                                ...
                                <div class="mt-3 form-group">
                                    ...
                                    <textarea name="add_description" id="editor1" class="form-control " rows="7" placeholder="Enter Description">{{ old('add_description') }}</textarea>
                                </div>
                                <div class="row mt-3">
