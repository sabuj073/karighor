...
@section('content')
    <section class="bradcrum_sec_pad">
        <div class="page-title text-center"
            ...
            <div class="contact_tag1 text-center text-bold">{{ $hotel_booking->title }}</div>
            <hr class="hr_for_all">
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-5">
                    <img src="{{ $hotel_booking->photo }}" width="100%" alt="">
                    <div class="mt-4">
                        <form action="">
                            @csrf
                            <div class="block">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#profile" role="tab"
                                ...
                                onclick="getProductId({{ @$hotel_booking->id }})">REVIEW</a>
                        </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="review-message pl-3 mt-3">
                                Be the first to review “{{ $hotel_booking->title }}”<br>
    ...
    <script>
        ...
        $(function() {
            ...
            $('#rating_submit').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('user.rating.bookingstore') }}",
                    type: 'POST',
                    data: {
